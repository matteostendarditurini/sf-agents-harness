...
- **js-ts-typing** -- Practical JavaScript and TypeScript type-safety patterns: discriminated unions, `// @ts-check`, strict compiler settings, `unknown` vs `any`, schema validation, branded types, `as const`, and immutability.
